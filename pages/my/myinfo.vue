	...
	<view class="center">
			...
			<view class="profily">
				<view class="base">
					<view class="profily_header">
						...
						<image :src="user.useravatarurl" class="userAvatarUrl" mode="scaleToFill" webp="true">
							<text class="userNickName">{{user.username}}</text>
		...
		<view class="content-list" v-if="content_list.length != 0"  hover-class="content-list-hover" v-for="(item,index) in content_list"
			...
			<view class="content-title">
				...
				<image class="content-share-more" src="../../static/ellipsis-h.png" @click="showactionsheet(item)"></image>
